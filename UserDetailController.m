...
@synthesize user,userList;

@synthesize idLabel,usernameLabel,firstnameLabel,lastnameLabel,emailLabel,addressLabel,phoneLabel;
...
{
    [super viewDidLoad];
    idLabel.text =[NSString stringWithFormat:@"%d",user.userId];
...
- (IBAction)deleteUser:(id)sender {
    NSInteger success = 0;
    NSString *post =[[NSString alloc] initWithFormat:@"%d",user.userId];
    
    NSURL *url=[NSURL URLWithString:@"http://localhost:8080/edu/ios/deleteUser"];
    ...
    [dict setObject:post forKey:@"user_id"];
